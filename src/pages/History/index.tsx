...
import { sortTasks, type SortTaskOptions } from "../../util/sortTasks";
...
export function History(/*props: HomeProps*/) {
  ...
  return (
    <MainTemplate>
      <Container>
        <Heading>
          <span className={styles.history}>Histórico</span>
          {hasTasks && (
                ...
                {sortTasksOptions.tasks.map((task) => {
                  ...
                  return (
                    <tr key={task.id}>
                      ...
                      <td>{taskDictiorany[task.type]}</td>
                    </tr>
                  );
                })}
              </tbody>
